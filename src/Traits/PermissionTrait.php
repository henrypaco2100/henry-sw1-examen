...
trait PermissionTrait
{
    ...
    {
        return $this->belongsToMany('\henry\sw1\Models\Permission')->withTimestamps();
    }
    ...
    public function getPermissions()
    {
        ...
        $cacheKey   = 'Henry.'.substr(static::getsw1Tag(), 0, -1).'.permissions.'.$primaryKey;

        if (method_exists(app()->make('cache')->getStore(), 'tags')) {
            return app()->make('cache')->tags(static::getsw1Tag())->remember($cacheKey, 60, function () {
