...
trait sw1Trait
{
    ...
    /**
     * The sW1 cache tag used by the user model.
     *
     * @return string
     */
    ...
    */
    ...
    {
        return $this->belongsToMany('\henry\sw1\Models\Role')->withTimestamps();
    }
    ...
    public function assignRole($roleId = null)
    {
        ...
        if (!is_numeric($roleId)) {
            $roleId = \henry\sw1\Models\Role::where('slug', $roleId)->pluck('id')->first();
        }
